...
class Analyzer:
    ...
    def plot_chart(self, data, n, ticker):
        """plot the information of one single stock (including: Moving Average,
           MACD, RSI, Volume)
           param date: dataframe
           param n: days to show before the end date
           param ticker: one single stock sympol
...
if __name__ == "__main__" : 
    ...
    # b.plot_momentum(['AAPL'], "2020-09-01", 255)
     df =  helper.get_historical_data('AAPL', '2010-01-01', '2010-10-01')  
